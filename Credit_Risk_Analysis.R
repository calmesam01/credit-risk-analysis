...
###################################################################################################
### Let's understand the incremental gain within the levels of categorical variables ###
###################################################################################################
...
# we saw that the data is completely unrealistic such as age under the 18 applicants show that they have a phd degree and married. Because we can see that 
